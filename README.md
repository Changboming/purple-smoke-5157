...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/purple-smoke-5157
```

A live public deployment of this template is available at [https://purple-smoke-5157.templates.workers.dev](https://purple-smoke-5157.templates.workers.dev)
